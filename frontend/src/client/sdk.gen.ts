...
export class FeasibilityService {
     ...
     * @param data The data for the request.
     * @param data.recommendation
     * @param data.reviewedOnly
     * @returns ScorecardResponse Successful Response
     * @throws ApiError
     */
    public static pipelineScorecard(data: FeasibilityPipelineScorecardData = {}): CancelablePromise<FeasibilityPipelineScorecardResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/feasibility/scorecard',
            query: {
                recommendation: data.recommendation,
                reviewed_only: data.reviewedOnly
            },
            errors: {
                422: 'Validation Error'
            }
...
export class FeasibilityAssessmentService {
     ...
     * @throws ApiError
     */
    public static editAssessmentNotes(data: FeasibilityAssessmentEditAssessmentNotesData): CancelablePromise<FeasibilityAssessmentEditAssessmentNotesResponse> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/deals/{deal_id}/feasibility/notes',
            path: {
                deal_id: data.dealId
            },
            body: data.requestBody,
...
export class ProjectsService {
     ...
     * @throws ApiError
     */
    public static listProjectDocuments(data: ProjectsListProjectDocumentsData): CancelablePromise<ProjectsListProjectDocumentsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/projects/{id}/documents',
            path: {
                id: data.id
            },
            errors: {
...
export class TasksService {
     ...
     * @param data.status
     * @param data.dealId
     * @param data.taskOwnerId
     * @param data.overdueOnly
     * @param data.dueFrom
     * @param data.dueTo
     * @param data.hideArchived
    ...
    public static listTasks(data: TasksListTasksData = {}): CancelablePromise<TasksListTasksResponse> {
        return __request(OpenAPI, {
            ...
            query: {
                ...
                status: data.status,
                deal_id: data.dealId,
                task_owner_id: data.taskOwnerId,
                overdue_only: data.overdueOnly,
                due_from: data.dueFrom,
                due_to: data.dueTo,
                hide_archived: data.hideArchived
            },
            errors: {
                422: 'Validation Error'
            }
     ...
     * @throws ApiError
     */
    public static bulkUpdateTasks(data: TasksBulkUpdateTasksData): CancelablePromise<TasksBulkUpdateTasksResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static bulkDeleteTasks(data: TasksBulkDeleteTasksData): CancelablePromise<TasksBulkDeleteTasksResponse> {
        return __request(OpenAPI, {
            method: 'POST',
